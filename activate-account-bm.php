<!-- Account Activation Page (Bahasa Melayu) -->
...
if (empty($token)) {
    die('Token tidak sah atau telah tamat tempoh.');
}
...
<body>
    <div class="container">
        ...
        <div class="text-center mt-2">
            <p>Akaun berjaya diaktifkan. Anda kini boleh <a href="login.php">log masuk</a>.</p>
        </div>
    </div>
</body>
